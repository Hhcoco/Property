 ...
 */
public class MTipList implements Parcelable {

    /**/
    @JSONField(name="items")
    public List<MTipListItem> items ;
    /**/
    ...
    protected MTipList(Parcel in) {
        this.items = in.createTypedArrayList(MTipListItem.CREATOR);
    ...
    public static final Creator<MTipList> CREATOR = new Creator<MTipList>() {
        @Override
        public MTipList createFromParcel(Parcel source) {
            return new MTipList(source);
        }

        @Override
        public MTipList[] newArray(int size) {
            return new MTipList[size];
        }
    };
}
