...
public class HandleKeyOk extends Fragment implements View.OnClickListener , SwipeRefreshLayout.OnRefreshListener , OnLoadMoreListener{
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
                if(mData!=null&&mData.size()>0){
                    ...
                    if("0".equalsIgnoreCase(state))
                        state = "待处理";
                    else if("1".equalsIgnoreCase(state)) state = "已驳回";
                    else if("2".equalsIgnoreCase(state)) state = "已同意";
