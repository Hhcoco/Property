...
public class HandleKeyDelayNo extends Fragment implements View.OnClickListener , SwipeRefreshLayout.OnRefreshListener , OnLoadMoreListener{
    ...
    public void update(MEventBusMsg msg){
        if(Config.KEYLISTDELAY_CHANGED.equalsIgnoreCase(msg.getMsg())){
            page = 1;
            getApplyData();
        }
    }
